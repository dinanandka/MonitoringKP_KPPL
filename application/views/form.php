			...
			<div class="container"> 
				...
				<div class="collapse navbar-collapse"> 
					<ul class="nav navbar-nav navbar-right">
						<li class="scroll"><a href="<?php echo base_url('index.php/c_user/index');?>">Home</a></li> 
			...
			<div class="row text-center clearfix">
				<div class="col-sm-8 col-sm-offset-2">
					<div class="contact-heading">
						...
						<p>Laporan Kegiatan Harian Selama Kerja Praktik</p>
					</div>
				</div>
			</div>
		</div>
								...
								<div class="status alert alert-success" style="display: none"></div>
						            ...
						            <fieldset>
							            <div class="col-sm-12"> 
							                ...
							                <div class="form-group">
								    	        <h5>Nama Dosen Pembimbing :</h5>
									 	        <input placeholder=" Enter Nama Dosen" name="dospem" type="text" value="" required data-validation-required-message="Siapa nama dosen pembimbing anda?"> 
									 	        <p class="help-block text-danger"></p>
								     	    </div>
								        </div>
						                <br></br>
							            <div class="col-sm-12"> 
							                <div class="form-group"> 
							           	        <h5>Judul :</h5>
										        <textarea rows="1" cols="72" name="topik" type="text" value="" required data-validation-required-message="Judul harus dimasukkan"> </textarea>
										    </div>
									        <div class="form-group">
									            <h5>Isi :</h5>
									            <textarea cols="144" rows="5"  name="isi" type="text" value="" required data-validation-required-message="Harus ada isinya"> </textarea>
									        </div>
									    </div>
										<br><br>
							          	<div class="col-sm-12"> 
