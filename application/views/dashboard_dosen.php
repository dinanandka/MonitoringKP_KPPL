...
<head>
  ...
  <title>SISFOR KP - Dashboard Dosen</title>
        ...
        <div class="panel panel-orange panel-widget">
          <div class="row no-padding">
            ...
            <div class="col-sm-9 col-lg-7 widget-right">
              ...
              <div class="text-muted">New Reports</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-6 col-md-3">
        <div class="panel panel-default">
          <div class="panel-body easypiechart-panel">
            <h4>New Reports</h4>
            <div class="easypiechart" id="easypiechart-orange" data-percent="26"><span class="percent">26%</span> </div>
          </div>
        </div>
      </div>
    </div>
