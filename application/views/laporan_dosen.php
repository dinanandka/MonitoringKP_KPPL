...
<head>
  ...
  <title>SISFOR KP - Laporan Mahasiswa</title>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="box">
          ...
          <p class="text-muted">Berikut daftar laporan dari mahasiswa yang sedang mengambil KP.</p>
          <hr>
          <div class="table-responsive">
            <table class="table table-hover">
              <thead>
				...
				<?php foreach($laporan as $p){ ?>
									   ...
									   <td><?php echo $p['nama'] ?></td>
										...
										<td>
										<?php echo anchor('crud/edit/'.$p['tanggal'],'Edit'); ?>
										<?php echo anchor('crud/hapus/'.$p['tanggal'].'/','Hapus'); ?>
										</td>
										</tr>
              ...
              <tbody>
              <!--
              <form method="post" action="<?php echo site_url().'index.php/crud/???'?>">
